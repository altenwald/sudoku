defmodule SudokuGame.Board do
  ...
  @spec new([[content()]]) :: t()
  @doc """
  Generates a new board based on the data provided.
  """
  ...
  solved board, it's giving the result immediately but if you try to
  ...
  @spec has_solution?(t()) :: boolean()
  @doc """
  Has the board a possible solution? It replies true or false.
  """
  def has_solution?(board), do: solve(board) != :no_solution
